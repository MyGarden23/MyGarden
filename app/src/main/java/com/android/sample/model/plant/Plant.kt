 ...
 *
 * This data class encapsulates all essential information about a plant,
 * including its identification, visual representation, health status,
 ...
 *
 * This data class extends the basic Plant information with tracking data
 * specific to the user's care routine, such as watering history.
 *
