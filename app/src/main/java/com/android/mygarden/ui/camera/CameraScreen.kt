        ...
        content = { paddingValues ->
            Box(modifier = modifier
                ...
                if (cameraPermission.value) {
                    ...
                    NoCameraAccessScreen(onReaskCameraAccess = {
                        ...
                        try {
                            ...
                            Toast.makeText(context, "Error accessing the settings app :(", Toast.LENGTH_SHORT).show()
                        }
                    },
                        onGalleryAccess = {
                            photoPickerLauncher.launch(PickVisualMediaRequest(ActivityResultContracts.PickVisualMedia.ImageOnly))
...
/**
 * Composable that allows the user to upload photos from the
 * gallery even when no camera access is granted
 *
 * @param modifier the optional modifier of the composable
 ...
 */
@Composable
private fun NoCameraAccessScreen(modifier: Modifier = Modifier,
                                 onGalleryAccess: () -> Unit = {}, onReaskCameraAccess: () -> Unit = {}) {
